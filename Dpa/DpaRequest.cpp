...
int32_t DpaRequest::EstimateStdTimeout(uint8_t hops, uint8_t hops_response, uint8_t timeslot, int32_t response)
{
...
int32_t DpaRequest::EstimateLpTimeout(uint8_t hops, uint8_t hops_response, uint8_t timeslot, int32_t response)
{
	auto estimated_timeout_ms = (hops + 1) * timeslot * 10;
	int32_t response_time_slot_length_ms;
	if (timeslot == 20)
